...
local function openSearch()
	...
	Main.Search.Size = UDim2.new(1, howWidth, 0, 80)
	...
	TweenService:Create(Main.Search, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(1, howWidth, 0, 35)}):Play()
end

local function closeSearch()
	searchOpen = false

	TweenService:Create(Main.Search, TweenInfo.new(0.35, Enum.EasingStyle.Quint), {BackgroundTransparency = 1, Size = UDim2.new(1, howWidth, 0, 30)}):Play()
...
local function Hide(notify: boolean?)
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 470 + howWidth, 0, 0)}):Play()
...
local function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 500 + howWidth, 0, 275) or UDim2.new(0, 500 + howWidth, 0, 475)}):Play()
...
local function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 495 + howWidth, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	task.wait(0.1)
	TweenService:Create(Main, TweenInfo.new(0.6, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Size = useMobileSizing and UDim2.new(0, 500 + howWidth, 0, 275) or UDim2.new(0, 500 + howWidth, 0, 475)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {ImageTransparency = 0.6}):Play()
