...
-- Define the width adjustment variable
local lolWidth = 50
...
Converted["_watermark"].Position = UDim2.new(0.95, -204, 0.0188679248, 0)
Converted["_watermark"].Size = UDim2.new(0, 300 + lolWidth, 0, 29)
...
function Library:New(options: table)
	...
	do
		...
		GUI["2"]["Size"] = UDim2.new(0, 380 + lolWidth, 0, 436);
	...
	do
		...
		GUI["3a"]["Size"] = UDim2.new(0, 380 + lolWidth, 0, 44);
	...
	do
		...
		GUI["29"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 23);
	...
	function GUI:CreateTab(options: table)
		...
		do
			...
			Tab["4"]["Size"] = UDim2.new(0, 380 + lolWidth, 0, 355);
			...
			Tab["5"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 450);
		...
		function Tab:Button(options: table)
			...
			do
				...
				Button["8"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 30);
		...
		function Tab:Slider(options: table)
			...
			do
				...
				Slider["25"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 43);
		...
		function Tab:Toggle(options: table)
			...
			do
				...
				Toggle["18"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 30);
		...
		function Tab:Textbox(options: table)
			...
			do
				...
				Textbox["12"]["Size"] = UDim2.new(0, 350 + lolWidth, 0, 30);
